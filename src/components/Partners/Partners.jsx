        ...
        >
          ...
          <PartnersContainer>
            <div
              ...
              onClick={() => window.open("https://www.edebe.com.br/", "_blank")}
            >
              <PartnerImg
            ...
            <div
              ...
              onClick={() => window.open("https://isma.org.br/", "_blank")}
            >
              <PartnerImg
                style={{ borderRadius: "25px" }}
                src={isma}
          ...
          >
            ...
            >
              ...
              <MaterialContainer
                onClick={() =>
                  window.open(
                    "https://facebook.com/colegiodomboscolestemanaus",
                    "_blank"
                  )
                }
              >
              ...
              <MaterialContainer
                onClick={() =>
                  (window.location.href =
                    window.location.origin + "#/institucional")
                }
              >
