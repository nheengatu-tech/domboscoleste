...
const SecNotice = (props) => {
  ...
  return(
    <div>
      <Helmet>
        <meta property="og:title" content="O Colégio Dom Bosco Leste inicio da campanha de matrículas 2021."></meta>
      ...
      <BodyNotice>
        <div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            src={campanhaMatricula} alt={"campanha de matrículas 2021"} />
...
Agende sua visita!
Mais informações: (92) 3131-4116/ 99259-9150
#JuntosParaVocêMudarOmundo #JuntosParaVocêSer+ #MatrículasAbertas  #SomosArsb #RSB</p>
            <div>
              Clique
              <a href="https://www.flickr.com/photos/190154461@N08/albums/72157716063955147" target="_blank">
              {' '} aqui
              </a> para ver todas as fotos
            </div>
            <div style={{ display: "flex" }}>
              ...
              <FacebookShareButton
                ...
                quote={"O Colégio Dom Bosco Leste inicia campanha e renovação de matrículas 2021."
                }
                url={`https://www.domboscoleste.com.br${window.location.pathname}`}>
                  <Helmet>
                    <meta property="og:title" content="O Colégio Dom Bosco Leste inicia campanha e renovação de matrículas 2021."></meta>
                    <meta property="og:image" content={campanhaMatricula}></meta>
                    <meta property="og:image:type" content="image/jpg"></meta>
                    <meta property="og:url" content={window.location.href}></meta>
                  </Helmet>
