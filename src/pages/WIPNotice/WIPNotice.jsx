  ...
  return (
    <div>
      <Helmet>
        <meta
          property="og:title"
          content="O Colégio Dom Bosco Leste anuncia o Edital de Bolsas 2021."
        ></meta>
      ...
      <BodyNotice>
        <div>
          ...
          >
            ...
            <p>
              O processo seletivo disponibiliza mais de 30 bolsas, sendo
              parciais (50%) e integrais (100%) para o Ensino Fundamental II ao
              Ensino Médio, sem taxa de inscrição, destinadas exclusivamente aos
              candidatos que se encontram em situação de vulnerabilidade social
              e que comprovem sua situação por meio de avaliação socioeconômica.
            ...
            <div>
              ...
              para se candidatar à Bolsa 2021
            </div>
            <div>
              Clique
              <a
                href="https://drive.google.com/file/d/1GIhelk5TJrMkr16C7212Ez0MaMJYGuIL/view?usp=sharing"
                target="blank"
              >
                {" "}
                aqui
